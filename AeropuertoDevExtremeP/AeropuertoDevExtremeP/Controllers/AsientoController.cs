...
namespace AeropuertoDevExtremeP.Controllers
{
    public class AsientoController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Get(DataSourceLoadOptions loadOptions)
        {
            ...
            List<Asiento> listaasiento = JsonConvert.DeserializeObject<List<Asiento>>(respuestaJson);
            return Request.CreateResponse(DataSourceLoader.Load(listaasiento, loadOptions));
        }
        ...
        public static async Task<string> GetAsync(string uri)
        {
            try
            {
                ...
                {
                    var response = await asiento.GetAsync(uri);
        ...
        public async Task<HttpResponseMessage> Post(FormDataCollection form)
        {
            ...
            using (var asiento = new HttpClient(handler))
            {
                var response = await asiento.PostAsync(url, httpContent);
        ...
        public async Task<HttpResponseMessage> Delete(FormDataCollection form)
        {
            ...
            using (var asiento = new HttpClient(handler))
            {
                var respuestaasiento = await asiento.DeleteAsync(apiUrlDelasiento);
            }
        ...
        public async Task<HttpResponseMessage> Put(FormDataCollection form)
        {
            ...
            string jsonString = JsonConvert.SerializeObject(asiento);
